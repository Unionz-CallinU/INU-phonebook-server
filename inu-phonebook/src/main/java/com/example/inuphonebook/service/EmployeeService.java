...
import com.example.inuphonebook.dto.employee.EmployeeReqDto;
import com.example.inuphonebook.dto.employee.EmployeeReqDto.EmployeeSearchReqDto;
import com.example.inuphonebook.dto.employee.EmployeeRespDto;
...
public class EmployeeService {
    ...
    public EmployeeListRespDto 직원리스트조회(EmployeeSearchReqDto employeeSearchReqDto) {
    ...
    public EmployeeDetailRespDto 직원상세조회(Long id) {
